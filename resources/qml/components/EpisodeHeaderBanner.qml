...
Rectangle {
    ...
    RowLayout {
        ...
        // Episode code badge
        Rectangle {
            Layout.preferredWidth: Theme.isCompact ? 60 : 80
            Layout.preferredHeight: Theme.isCompact ? 32 : 40
            ...
            Text {
                ...
                color: Theme.portalGreen
                font.pixelSize: Theme.isCompact ? 14 : 18
                font.bold: true
        ...
        Text {
            ...
            font.pixelSize: Theme.bannerTitleSize
            font.bold: true
